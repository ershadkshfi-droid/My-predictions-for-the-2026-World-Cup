...
export function MatchesManager() {
  ...
  const handleSeedWorldCup = async () => {
    ...
    try {
      ...
      const addMatchUTC = (dateStr: string, timeStr: string, groupOrStage: string, t1: string, t2: string) => {
      ...
      const hardcodedGroupMatches = [
        // 11 June
        { d: '2026-06-11', t: '19:00', h: 'المكسيك', a: 'جنوب أفريقيا', g: 'Group A' },
        { d: '2026-06-12', t: '02:00', h: 'كوريا الجنوبية', a: 'التشيك', g: 'Group A' }, 
        
        // 12 June
        { d: '2026-06-12', t: '19:00', h: 'كندا', a: 'البوسنة والهرسك', g: 'Group B' },
        { d: '2026-06-13', t: '01:00', h: 'أمريكا', a: 'باراغواي', g: 'Group D' }, 

        // 13 June
        { d: '2026-06-13', t: '19:00', h: 'قطر', a: 'سويسرا', g: 'Group B' },
        { d: '2026-06-13', t: '22:00', h: 'البرازيل', a: 'المغرب', g: 'Group C' },
        { d: '2026-06-14', t: '01:00', h: 'هايتي', a: 'اسكتلندا', g: 'Group C' },

        // 14 June
        { d: '2026-06-14', t: '04:00', h: 'أستراليا', a: 'تركيا', g: 'Group D' },
        { d: '2026-06-14', t: '17:00', h: 'ألمانيا', a: 'كوراساو', g: 'Group E' },
        { d: '2026-06-14', t: '20:00', h: 'هولندا', a: 'اليابان', g: 'Group F' },
        { d: '2026-06-14', t: '23:00', h: 'ساحل العاج', a: 'الإكوادور', g: 'Group E' },
        { d: '2026-06-15', t: '02:00', h: 'السويد', a: 'تونس', g: 'Group F' },

        // 15 June
        { d: '2026-06-15', t: '16:00', h: 'إسبانيا', a: 'الرأس الأخضر', g: 'Group H' },
        { d: '2026-06-15', t: '19:00', h: 'بلجيكا', a: 'مصر', g: 'Group G' },
        { d: '2026-06-15', t: '22:00', h: 'السعودية', a: 'الأوروغواي', g: 'Group H' },
        { d: '2026-06-16', t: '01:00', h: 'إيران', a: 'نيوزيلندا', g: 'Group G' },

        // 16 June
        { d: '2026-06-16', t: '19:00', h: 'فرنسا', a: 'السنغال', g: 'Group I' },
        { d: '2026-06-16', t: '22:00', h: 'العراق', a: 'النرويج', g: 'Group I' },
        { d: '2026-06-17', t: '01:00', h: 'الأرجنتين', a: 'الجزائر', g: 'Group J' },

        // 17 June
        { d: '2026-06-17', t: '04:00', h: 'النمسا', a: 'الأردن', g: 'Group J' },
        { d: '2026-06-17', t: '17:00', h: 'البرتغال', a: 'الكونغو الديمقراطية', g: 'Group K' },
        { d: '2026-06-17', t: '20:00', h: 'إنجلترا', a: 'كرواتيا', g: 'Group L' },
        { d: '2026-06-17', t: '23:00', h: 'غانا', a: 'بنما', g: 'Group L' },
        { d: '2026-06-18', t: '02:00', h: 'أوزبكستان', a: 'كولومبيا', g: 'Group K' },

        // 18 June
        { d: '2026-06-18', t: '16:00', h: 'التشيك', a: 'جنوب أفريقيا', g: 'Group A' }, 
        { d: '2026-06-18', t: '19:00', h: 'سويسرا', a: 'البوسنة والهرسك', g: 'Group B' },
        { d: '2026-06-18', t: '22:00', h: 'كندا', a: 'قطر', g: 'Group B' },
        { d: '2026-06-19', t: '01:00', h: 'المكسيك', a: 'كوريا الجنوبية', g: 'Group A' },

        // 19 June
        { d: '2026-06-19', t: '19:00', h: 'أمريكا', a: 'أستراليا', g: 'Group D' },
        { d: '2026-06-19', t: '22:00', h: 'اسكتلندا', a: 'المغرب', g: 'Group C' },
        { d: '2026-06-20', t: '00:30', h: 'البرازيل', a: 'هايتي', g: 'Group C' },
        { d: '2026-06-20', t: '03:00', h: 'تركيا', a: 'باراغواي', g: 'Group D' },

        // 20 June
        { d: '2026-06-20', t: '17:00', h: 'هولندا', a: 'السويد', g: 'Group F' },
        { d: '2026-06-20', t: '20:00', h: 'ألمانيا', a: 'ساحل العاج', g: 'Group E' },
        { d: '2026-06-21', t: '00:00', h: 'الإكوادور', a: 'كوراساو', g: 'Group E' },

        // 21 June
        { d: '2026-06-21', t: '04:00', h: 'تونس', a: 'اليابان', g: 'Group F' },
        { d: '2026-06-21', t: '16:00', h: 'إسبانيا', a: 'السعودية', g: 'Group H' },
        { d: '2026-06-21', t: '19:00', h: 'بلجيكا', a: 'إيران', g: 'Group G' },
        { d: '2026-06-21', t: '22:00', h: 'الأوروغواي', a: 'الرأس الأخضر', g: 'Group H' },
        { d: '2026-06-22', t: '01:00', h: 'نيوزيلندا', a: 'مصر', g: 'Group G' },

        // 22 June
        { d: '2026-06-22', t: '17:00', h: 'الأرجنتين', a: 'النمسا', g: 'Group J' },
        { d: '2026-06-22', t: '21:00', h: 'فرنسا', a: 'العراق', g: 'Group I' },
        { d: '2026-06-23', t: '00:00', h: 'النرويج', a: 'السنغال', g: 'Group I' },
        { d: '2026-06-23', t: '03:00', h: 'الأردن', a: 'الجزائر', g: 'Group J' },

        // 23 June
        { d: '2026-06-23', t: '17:00', h: 'البرتغال', a: 'أوزبكستان', g: 'Group K' },
        { d: '2026-06-23', t: '20:00', h: 'إنجلترا', a: 'غانا', g: 'Group L' },
        { d: '2026-06-23', t: '23:00', h: 'بنما', a: 'كرواتيا', g: 'Group L' },
        { d: '2026-06-24', t: '02:00', h: 'كولومبيا', a: 'الكونغو الديمقراطية', g: 'Group K' },

        // 24 June
        { d: '2026-06-24', t: '19:00', h: 'سويسرا', a: 'كندا', g: 'Group B' },
        { d: '2026-06-24', t: '19:00', h: 'البوسنة والهرسك', a: 'قطر', g: 'Group B' },
        { d: '2026-06-24', t: '22:00', h: 'اسكتلندا', a: 'البرازيل', g: 'Group C' },
        { d: '2026-06-24', t: '22:00', h: 'المغرب', a: 'هايتي', g: 'Group C' },
        { d: '2026-06-25', t: '01:00', h: 'التشيك', a: 'المكسيك', g: 'Group A' },
        { d: '2026-06-25', t: '01:00', h: 'جنوب أفريقيا', a: 'كوريا الجنوبية', g: 'Group A' },

        // 25 June
        { d: '2026-06-25', t: '20:00', h: 'الإكوادور', a: 'ألمانيا', g: 'Group E' },
        { d: '2026-06-25', t: '20:00', h: 'كوراساو', a: 'ساحل العاج', g: 'Group E' },
        { d: '2026-06-25', t: '23:00', h: 'تونس', a: 'هولندا', g: 'Group F' },
        { d: '2026-06-25', t: '23:00', h: 'اليابان', a: 'السويد', g: 'Group F' },
        { d: '2026-06-26', t: '02:00', h: 'تركيا', a: 'أمريكا', g: 'Group D' },
        { d: '2026-06-26', t: '02:00', h: 'باراغواي', a: 'أستراليا', g: 'Group D' },

        // 26 June
        { d: '2026-06-26', t: '19:00', h: 'النرويج', a: 'فرنسا', g: 'Group I' },
        { d: '2026-06-26', t: '19:00', h: 'السنغال', a: 'العراق', g: 'Group I' },
        { d: '2026-06-27', t: '00:00', h: 'الأوروغواي', a: 'إسبانيا', g: 'Group H' },
        { d: '2026-06-27', t: '00:00', h: 'الرأس الأخضر', a: 'السعودية', g: 'Group H' },
        { d: '2026-06-27', t: '03:00', h: 'نيوزيلندا', a: 'بلجيكا', g: 'Group G' },
        { d: '2026-06-27', t: '03:00', h: 'مصر', a: 'إيران', g: 'Group G' },

        // 27 June
        { d: '2026-06-27', t: '21:00', h: 'بنما', a: 'إنجلترا', g: 'Group L' },
        { d: '2026-06-27', t: '21:00', h: 'كرواتيا', a: 'غانا', g: 'Group L' },
        { d: '2026-06-27', t: '23:30', h: 'كولومبيا', a: 'البرتغال', g: 'Group K' },
        { d: '2026-06-27', t: '23:30', h: 'الكونغو الديمقراطية', a: 'أوزبكستان', g: 'Group K' },
        { d: '2026-06-28', t: '02:00', h: 'الأردن', a: 'الأرجنتين', g: 'Group J' },
        { d: '2026-06-28', t: '02:00', h: 'الجزائر', a: 'النمسا', g: 'Group J' }
      ];

      const groupRounds: Record<string, number> = {};
      hardcodedGroupMatches.forEach((m) => {
        const groupLetter = m.g.split(' ')[1];
        if (!groupRounds[groupLetter]) groupRounds[groupLetter] = 0;
        groupRounds[groupLetter] += 1;
        const round = Math.ceil(groupRounds[groupLetter] / 2);
        
        addMatchUTC(m.d, m.t, `المجموعة ${groupLetter} - الجولة ${round}`, m.h, m.a);
      });

      // Round of 32 (16 Matches)
      const r32Dates = ['2026-06-28', '2026-06-29', '2026-06-30', '2026-07-01', '2026-07-02', '2026-07-03'];
      let idR32 = 1;
      const tso = ["20:00", "23:00", "02:00", "05:00"];
      for(let d of r32Dates) {
        let games = (d === '2026-06-28' || d === '2026-07-03') ? 2 : 3;
        for(let i=0; i<games; i++) {
          addMatchUTC(d, tso[Math.floor(Math.random()*4)], 'دور الـ 32', `المركز الأول أو الثاني`, `المركز الثاني أو أفضل ثالث`);
          idR32++;
        }
      }
      ...
      for(let d of r16Dates) {
        for(let i=0; i<2; i++) {
          addMatchUTC(d, i===0?'23:00':'02:00', 'دور الـ 16', `فائز دور 32 رقم ${idR16*2-1}`, `فائز دور 32 رقم ${idR16*2}`);
          idR16++;
        }
      }

      // Quarter Finals (4 Matches)
      addMatchUTC('2026-07-09', '02:00', 'ربع النهائي', 'فائز دور 16 رقم 1', 'فائز دور 16 رقم 2');
      addMatchUTC('2026-07-10', '23:00', 'ربع النهائي', 'فائز دور 16 رقم 3', 'فائز دور 16 رقم 4');
      addMatchUTC('2026-07-10', '02:00', 'ربع النهائي', 'فائز دور 16 رقم 5', 'فائز دور 16 رقم 6');
      addMatchUTC('2026-07-11', '02:00', 'ربع النهائي', 'فائز دور 16 رقم 7', 'فائز دور 16 رقم 8');

      // Semi-finals (2 Matches)
      addMatchUTC('2026-07-14', '02:00', 'نصف النهائي', 'فائز ربع النهائي 1', 'فائز ربع النهائي 2');
      addMatchUTC('2026-07-15', '02:00', 'نصف النهائي', 'فائز ربع النهائي 3', 'فائز ربع النهائي 4');

      // Third Place (1 Match)
      addMatchUTC('2026-07-18', '23:00', 'تحديد المركز الثالث', 'خاسر نصف النهائي 1', 'خاسر نصف النهائي 2');

      // Final (1 Match)
      addMatchUTC('2026-07-19', '23:00', 'النهائي', 'فائز نصف النهائي 1', 'فائز نصف النهائي 2');
